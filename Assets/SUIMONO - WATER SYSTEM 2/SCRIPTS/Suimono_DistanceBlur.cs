...
namespace Suimono.Core
{
	...
	public class Suimono_DistanceBlur : MonoBehaviour {
		...
		bool CreateMaterial() {
		    ...
		    if (blurShader == null) {
		    	blurShader = Shader.Find("Hidden/SuimonoDistanceBlur");
		    }

		    if (blurShader == null) {
		    	Debug.LogWarning("[Suimono_DistanceBlur] Hidden/SuimonoDistanceBlur shader was not found. Distance blur will be bypassed.");
		    	enabled = false;
		    	return false;
		    }
