...
Pass{
	...
	half4 frag( v2f i ) : COLOR
	{
		...
		//Sample Depth
		half drefr = Linear01Depth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(i.uvs)));//i.ref
		half dref = Linear01Depth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(i.screenPos))); //uv2
