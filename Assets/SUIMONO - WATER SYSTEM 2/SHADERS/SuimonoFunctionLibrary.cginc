...
if (_sui_metalTestMode == 3){
	...
	void SuimonoSurf (Input IN, inout SurfaceOutput o) {
		...
		float sceneZ2 = 0;
		...
		#if UNITY_CAN_COMPILE_TESSELLATION
			//DX11
			sceneZ1 = Linear01Depth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(uv0)));
			sceneZ2 = Linear01Depth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(uv1)));
			...
			float rawDepth = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(uv1)));
			...
			float rawDepth2 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(uv0)));
